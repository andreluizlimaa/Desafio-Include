        ...
        <Container>
            ...
            <div className={styles.quem_somos}>
                ...
                <div className={styles.quem_somos_text}>
                    ...
                    <a href= "https://www.google.com" target="_blank"><button > Saiba mais</button></a>
                </div>
            </div>
            <div className={styles.container_brothers}>
                <div className={styles.container_brothers_perfils}>
                    ...
                    <div className={styles.brothers_perfils}>
                        <div className={styles.brother_1}><img src={brother_1} alt="logo_brother_1" /><h3>Pedro</h3></div>
                        <div className={styles.brother_2}><img src={brother_2} alt="logo_brother_2" /><h3>José</h3></div>
                        <div className={styles.brother_3}><img src={brother_3} alt="logo_brother_3" /><h3>Maria</h3></div>
                        <div className={styles.brother_4}><img src={brother_4} alt="logo_brother_4" /><h3>Edurda</h3></div>
                        <div className={styles.brother_5}><img src={brother_5} alt="logo_brother_5" /><h3>Júlia</h3></div>
                        <div className={styles.brother_6}><img src={brother_6} alt="logo_brother_6" /><h3>Lucas</h3></div>
                        <div className={styles.brother_7}><img src={brother_7} alt="logo_brother_7" /><h3>Gaby</h3></div>
                        <div className={styles.brother_8}><img src={brother_8} alt="logo_brother_8" /><h3>Enzo</h3></div>
                    </div>
                </div>
            </div>
            ...
            <div className={styles.container_include}>
                ...
                <div className={styles.video_include}>
                    <iframe width="300" height="280" src="https://www.youtube.com/embed/DPI8ivJjIkU" title="Raça Negra - Cheia de Manias (Deezer Sessions)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
            </div>
